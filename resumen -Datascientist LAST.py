...
# El baseline, lo mas basico sería probar modelos/herramientas clasicas de NLP:
#									- feature extraction:
#										- BoW/CountVectorizer/Bag of words. Cada oración pasa a ser un vector de 0 y 1 donde cada posición representa una palabra. el tamaño del vector de cada oración, es la qty de palabras q existen. llevar a low, verbo infinitivo, etc.
#										- Tf-idf (frecuencia de terminos/palabras + frecuencia inversa de documento, donde saca ponderación a las palabras que se repiten mucho)
